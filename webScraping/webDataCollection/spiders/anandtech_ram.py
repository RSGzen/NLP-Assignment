...
class AnandtechSpider_RAM(scrapy.Spider):
    name = "anandtech_memory"
    allowed_domains = ["www.anandtech.com"]
    start_urls = ["https://www.anandtech.com/tag/memory"]

    def __init__(self, *args, **kwargs):

        self.base_url = "https://www.anandtech.com/tag/memory"
