...
class AnandtechSpider_MB(scrapy.Spider):
    name = "anandtech_mb"
    allowed_domains = ["www.anandtech.com"]
    start_urls = ["https://www.anandtech.com/tag/mb"]

    def __init__(self, *args, **kwargs):

        self.base_url = "https://www.anandtech.com/tag/mb"
