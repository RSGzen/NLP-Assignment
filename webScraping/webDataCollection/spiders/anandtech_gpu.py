...
class AnandtechSpider_GPU(scrapy.Spider):
    name = "anandtech_gpus"
    allowed_domains = ["www.anandtech.com"]
    start_urls = ["https://www.anandtech.com/tag/gpus"]

    def __init__(self, *args, **kwargs):

        self.base_url = "https://www.anandtech.com/tag/gpus"
        self.current_link_idx = 2
        self.downloaded_articles_num = 0
        self.PAGE_HARD_LIMIT = 45
